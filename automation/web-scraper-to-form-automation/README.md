...
![Requests](https://img.shields.io/badge/Requests-HTTP-FF6B6B?style=for-the-badge&logo=python&logoColor=white)
![License](https://img.shields.io/badge/License-MIT-yellow?style=for-the-badge)
![Status](https://img.shields.io/badge/Status-Complete-brightgreen?style=for-the-badge)

> Part of [DevVault](https://github.com/qusai-Kagal/DevVault) — a curated mono-repo of 60+ projects across web dev, AI/ML, automation, and more.

A Python automation pipeline that scrapes real estate property listings from a Zillow clone and automatically submits the extracted data into a Google Form using Selenium — end-to-end, with zero manual input.

---

## 📌 What It Does

1. **Scrapes** property listings (address, price, link) from a Zillow clone using `requests` + `BeautifulSoup4`
2. **Automates** Google Form submission for every listing using `Selenium` WebDriver
3. **Handles errors gracefully** — skips failed entries and keeps the pipeline running
...
cd DevVault/automation/web-scraper-to-form-automation
```
...
- **User-Agent spoofing** — mimics a real browser to avoid being blocked by the target site
...
- Web scraping with `BeautifulSoup4` + CSS selectors
- Browser automation with `Selenium` WebDriver
- DOM interaction: XPath locators, form filling, button clicking
...
## 🗂️ More from DevVault

| Category | Projects |
|---|---|
| 🌐 Web Dev | DBank, SecureAuth Portal, Book Notes Tracker, Repo Vista |
| 🤖 AI/ML | Movie Recommender System, DeepSeek R1 Local Runner |
| 🛠️ Automation | Certificate Automation Tool, **Web Scraper to Form** |
| 🎮 Game Dev | Turtle Dash, Speed-Keys, Maze-Runner |

👉 [Explore all 60+ projects in DevVault](https://github.com/qusai-Kagal/DevVault)

---

## 📄 License

This project is licensed under the [MIT License](https://github.com/qusai-Kagal/DevVault/blob/main/LICENSE).
...
[![GitHub](https://img.shields.io/badge/GitHub-qusai--Kagal-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/qusai-Kagal)
